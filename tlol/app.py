...
class App:
    def __init__(self):
        pyxel.init(160, 120, caption="The Legend of LAN")

        pyxel.load("assets/tlol.pyxres")
        ...
        self.fruit = [(i * 60, randint(0, 104), 0, True) for i in range(4)]
    ...
    def draw(self):
        ...
        # draw tilemap
        #160, 120
        pyxel.bltm(x=0, y=0, tm=0, u=0, v=0, w=160, h=120)
        ...
        pyxel.blt(
            ...
            self.player_y,
            0,
            16 if self.player_vy > 0 else 32,
            0,
            16,
            16,
            12,
